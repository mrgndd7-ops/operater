  ...
  return (
    <div className="bg-black">
      ...
      <Hero
        ...
        titleNode={
          <>
            <span className="block font-light text-white/90">Scaling a startup does not always</span>
            <span className="block font-light text-white/90">mean hiring{" "}<span className="font-bold text-white">new people</span></span>
          </>
        }

...
2. Hero
   ...
   - Main headline with mixed typography weights
   - Two CTAs: "Join Waitlist" + "See how it works"
   - Backed by: NVIDIA Inception, Google for Startups, Cloudflare, Plug and Play logos

3. Problem Statement
   - "Work increases faster than small teams can handle"
   - Visual showing overwhelmed toolstack

4. Differentiator — "The easiest way to add AI agents to your team"
   - 3 steps minimal layout (no comparison table)
   - Step 1: Choose your LLM
   - Step 2: Define identity & responsibilities
   - Step 3: Activate
   - Minimal, on-brand, no competitor mentions

5. Product in Action
   - Real product screenshots from Figma
   - Show: onboarding flow, dashboard, agent creation
   - Animated — screens transition or stack with scroll

6. How it works
   - Horizontal scroll cards
   - "Work as you normally do" → "Agents as execution layer" → "Scale without adding people"

7. AI solutions for every team
   - Slider: Marketing / Operations / Sales
   - Each with ghost mascot visual

8. Capabilities
   - Horizontal bar: One source of truth / Context-aware agents / Autonomous decision making / Intelligent task execution

9. Integrations
   - "Fits into how you already work"
   - Tool logos orbiting ghost mascot

10. Social Proof
    - Real user quotes or tweets
    - Focus on scale, speed, team efficiency outcomes

11. Early Access CTA
    - "Limited spots available"
    - Email waitlist form
    - No pricing, no commitment language
